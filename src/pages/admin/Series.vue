<template>
	...
	<!-- 		<template v-slot:top-right>
			...
			<template v-slot:top>
				<q-btn class=" animate-pop" round	 dense color="primary" :disable="loading" icon="add" @click="$router.push({ name: 'GuardarSerie', params: { serie:{nombre:'La Maldicion De Hill House'} } })" />
				<!-- @click="removeRow" -->
